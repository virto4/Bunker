...
if clicou {
	for (var _i = 0; _i < paginas.numero; _i += 2) {
		pagina_esquerda = quebrar_texto(ds_list_find_value(paginas_escritas, _i), 425)
		pagina_direita = quebrar_texto(ds_list_find_value(paginas_escritas, _i + 1), 425)
	}
	...
	draw_text(1920 / 2 + 420, 1080 / 2 + 350, "avançar")
