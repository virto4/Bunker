...
paginas = {
	...
	leptospirose: "Tem ratos aqui no bunker; eles vem e vão pelas ventilações e ficam fazendo ruídos irrtantes de noite. Acho que eles me deixaram doente hoje.",
	freddie: "Tem alguém na porta...",
	doenca_gata: "Meredith está doente. Não sei o que fazer. Será que dou remédio para ela? Pode ser uma boa ideia.",
	eletricidade: "O sistema elétrico do bunker está se deteriorando. Preciso concertar com a caixa de ferramentas.",
	rachaduras: "Durante a noite parte do concreto cedeu... Devo concertar antes que a radiação entre.",
	infiltracao: "Hoje de madrugada os canos romperam e vazaram água no piso. Tenho que abrir e concertar isso.",
	termostato: "Está muito calor aqui dentro. A temperatura fica indo e voltando, oscilando. O termostato está quebrado.",
	...
	disenteria: "Minha barriga está doendo tanto... preciso de remédio para não morrer desnutrido dessa diarréia.",
	...
	ventilacao: "Os dutos de ventilação estão muito sujos. Meu nariz está pedindo socorro.",
