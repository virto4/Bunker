...
*/
falas = [
	[{fala: "Poxa, pai, que coisa horrível... será que algum dia vamos sair daqui?", retrato: spr_davi_deprimido /*davi triste*/, personagem: "Davi", 
	respostas: {um: "Com certeza", dois: "Não sei", tres: "Nunca"}, respostas2: {um: {fala: "É isso aí, pai!", retrato: spr_davi_extasiado, personagem: "Davi"}, dois: {fala: "É verdade, pai.", retrato: spr_davi_neutro /*roger neutro*/, personagem: "Davi"}, tres: {fala: "Nossa, pai... você é muito deprê.", retrato: spr_davi_deprimido, personagem: "Davi"}}}],
	[{fala: "Sabe a diferença entre uma privada e uma bicicleta?", retrato: spr_davi_neutro /*davi neutro*/, personagem: "Davi"},
	{fala: "A bicicleta você senta pra correr, a privada você corre pra sentar.", retrato: spr_davi_extasiado/*davi feliz*/, personagem: "Davi"},
	{fala: "O que você achou dessa piada, pai?", retrato: spr_davi_extasiado/*roger neutro*/, personagem: "Davi", 
		respostas: {um: "Horrível", dois: "Mais ou menos", tres: "Muito boa"}, respostas2: {um: {fala: "Nossa pai... Só queria descontrair um pouco...", retrato: spr_davi_deprimido, personagem: "Davi"}, dois: {fala: "É, eu também não gostei muito.", retrato: spr_davi_neutro/*roger neutro*/, personagem: "Davi"}, tres: {fala: "Obrigado, pai!", retrato: spr_davi_extasiado, personagem: "Davi"}}}],
	[{fala: "Está um tédio aqui dentro... não tem livros, não tem TV nem ar puro... Deus! Era feliz e não sabia lá fora...", retrato: spr_davi_deprimido/*davi triste*/, personagem: "Davi"}],
	[{fala: "Eaí, filho, tudo em cima?", retrato: spr_roger_extasiado/*roger feliz*/, personagem: "roger"}, {fala: "Bença, pai.", retrato: spr_davi_extasiado/*davi feliz*/, personagem: "Davi"}],
	//5
	[{fala: "Vamos lá, troca de pensamentos: eu lhe dou um pensamento meu, e você me dá um seu.", retrato: spr_roger_neutro/*roger neutro*/, personagem: "Roger"},
	{fala: "Eu começo: queria poder deitar na relva e desfrutar um piquenique ar pôr do sol, em família, como nos velhos tempos.", retrato: spr_davi_extasiado/*davi feliz*/, personagem: "Davi"},
	{fala: "Eu queria mesmo era experimentar pela última vez a torta de maçã da sua avó; com sorvete de creme ficava divina!", retrato: spr_roger_neutro/*roger neutro*/, personagem: "Roger"}],
	[{fala: "Não consigo parar de pensar naquela torta de maça da vovó... Será que ela sobreviveu? Nem quero imaginar.", retrato: spr_davi_deprimido/*davi triste*/, personagem: "Davi"}],
	[{fala: "Nunca pensei que sentiria tanta falta de fazer exercícios físicos!", retrato: spr_roger_neutro/*roger neutro*/, personagem: "Roger"},
	{fala: "Agora você me fez lembrar do meu tempo de jogador de basquete. Será que algum dia vou voltar a jogar?", retrato: spr_davi_deprimido/*davi triste*/, personagem: "Davi"}],
	[{fala: "Pai... você tem saudades da mamãe de vez em quando?", retrato: spr_acucar/*davi neutro*/, personagem: "Davi"},
	{fala: "Tenho filho... bastante, por quê?", retrato: spr_roger_neutro/*roger neutro*/, personagem: "Roger"}, {fala: "Nada não...", retrato: spr_davi_neutro/*davi neutro*/, personagem: "Davi"}],
	[{fala: "Pai: top 3 frutas, agora!", retrato: spr_davi_extasiado/*davi feliz*/, personagem: "Davi", 
	respostas: {um: "Maçã, pera e uva", dois: "Abacaxi, mamão e melancia", tres: "Tomate, pepino e laranja"}, respostas2: {um: {fala: "Boa escolha, pai! Gosta dos crocantes, né.", retrato: spr_davi_extasiado, personagem: "Davi"}, dois: {fala: "Uma vibe mais tropical, né.", retrato: spr_davi_extasiado/*roger neutro*/, personagem: "Davi"}, tres: {fala: "Jesus... Que pessoa amargurada você deve ser.", retrato: spr_davi_deprimido, personagem: "Davi",}}}],
	//10
	[{fala: "Pai, você acha que ainda tem gente lá fora?", retrato: spr_davi_neutro/*davi neutro*/, personagem: "Davi"},
	{fala: "Acho que sim, filho. Acho que tem muitas pessoas vagando por aí, mas não podemos ajudar nenhuma. Temos que nos preocupar com os nossos.", retrato: spr_roger_neutro/*roger neutro*/, personagem: "Roger"}],
	[{fala: "Tenho saudades da mamãe...", retrato: spr_davi_deprimido/*davi triste*/, personagem: "Davi"},
	{fala: "Filho, tente não falara muito disso, tá bom? Estamos bem melhor sem remoer mágoas do passado.", retrato: spr_roger_neutro/*roger neutro*/, personagem: "Roger"},
	{fala: "Pra você é fácil falar né? Já que foi você que não quis que ela fosse no médico porque 'os médicos não são confiáveis'!", retrato: spr_davi_colerico/*Davi com raiva*/, personagem: "Davi"},
	{fala: "E vai dizer que eu estou errado? Essas vacinas aí estã cheias de micróbios, os hospitais são sujos e contaminados e nenhum médico poderia ter tratado sua mãe melhor do que eu tratei!", retrato: spr_roger_colerico/*roger nervoso*/, personagem: "Roger"},
	{fala: "Nossa, pai... você é muito escroto! Você nem se importava com ela! Tratou-a como lixo a vida toda, você pensa que eu não ouvia suas brigas?", retrato: spr_davi_deprimido/*davi triste*/, personagem: "Davi"},
	{fala: "Vai meditar ou dormir, filho... você não está raciocinando direito...", retrato: spr_roger_neutro/*roger neutro*/, personagem: "Roger"}],
	[{fala: "Filho, vai querer café da manhã", retrato: spr_roger_neutro/*roger neutro*/, personagem: "Roger"}, {fala: "...", retrato: spr_davi_neutro/*davi neutro*/, personagem: "Davi"}, {fala: "Filho?... Está bem, então!. Pelo visto não quer conversar...", retrato: spr_roger_neutro/*roger neutro*/, personagem: "Roger"}],
	[{fala: "Pai... você vai se desculpar?", retrato: spr_davi_neutro/*davi neutro*/, personagem: "Davi"}, {fala: "Filho, não fiz nada de errado, e você saberia disso se me ouvisse de vez em quando.", retrato: spr_roger_neutro/*roger neutro*/, personagem: "Roger"},
	{fala: "Então diga, pai, diga o que você quer dizer.", retrato: spr_davi_colerico/*davi raiva*/, personagem: "Davi"},
	{fala: "Davi, tudo que eu fiz foi para nos proteger, tá bom? A prova final disso é que estamos a salvo! E você quer reclamar ainda assim? Tudo bem, eu reconheço que não fui o mais afetuoso com você, mas esse aqui é o meu jeito de demonstrar a minha fé nessa família.", retrato: spr_roger_neutro/*roger neutro*/, personagem: "Roger"},
	{fala: "Bem, concordo com você. Eu não entendo sua forma de cuidar de nós, mas acho que vocÊ também não entende a minha. E eu entendo que talvez você não foi o culpado pela morte da mamãe, já que ela mesma não queria ir no médico, já que fazia tudo que vocÊ mandava...", retrato: spr_davi_neutro/*davi neutro*/, personagem: "Davi"}],
	[{fala: "Agora quer café da manhã?", retrato: spr_roger_extasiado/*roger feliz*/, personagem: "Roger"}, {fala: "Pode ser, pai, obrigado.", retrato: spr_davi_extasiado/*davi feliz*/, personagem: "Davi"}],
	//15
	[{fala: "Vamos revisar os estoques.", retrato: spr_roger_neutro/*roger neutro*/, personagem: "Roger"}, {fala: "De novo?", retrato: spr_davi_neutro/*Davi neutro*/, personagem: "Davi"},
	{fala: "Segurança nunca é demais", retrato: spr_roger_neutro/*roger neutro*/, personagem: "Roger"}, {fala: "Você devia tatuar isso na testa.", retrato: spr_davi_neutro/*davi neutro*/, personagem: "Davi"}],
	[{fala: "Nossa, pai, não tem nada pra comer nessa casa!", retrato: spr_davi_neutro/*roger neutro*/, personagem: "Roger"}],
	[{fala: "Poxa, pai, estou vivendo hoje só esperando o dia em que poderei comer a torta de maçã da vovó de novo. Essa esperança é a única que me mantém de pé", retrato: spr_davi_extasiado/*davi feliz*/, personagem: "Davi"},
	{fala: "Você só pensa em comer também... puxou o lado da família da sua mãe.", retrato: spr_roger_neutro/*roger neutro*/, personagem: "Roger"}],
	[{fala: "Sabe o que eu queria comer agora?", retrato: spr_davi_neutro/*davi neutro*/, personagem: "Davi"}, {fala: "Deixa eu adivinhar: a torta de maçã da vovó.", retrato: spr_roger_neutro/*roger neutro*/, personagem: "Roger"},
	{fala: "Dessa vez não! Dessa vez é um copo de coca; tá maluco! Uma coquinha gelada... não tem pra ninguém.", retrato: spr_davi_extasiado/*davi feliz*/, personagem: "Davi"}],
	[{fala: "Filho, me lembrei agora do seu primeiro jogo no time de basquete da escola. Você tinha 8 anos! Lembro até hoje da garra com que enfrentou os mais velhos.", retrato: spr_roger_deprimido/*roger triste*/, personagem: "Roger"},
	{fala: "Obrigada, pai. Às vezes me esqueço desse seu lado.", retrato: spr_davi_extasiado/*davi feliz*/, personagem: "Davi"}],
	//20
	[{fala: "Você acredita em Deus, pai?", retrato: spr_davi_neutro/*davi neutro*/, personagem: "Davi"}, {fala: "Acreditava", retrato: spr_roger_neutro/*roger neutro*/, personagem: "Roger"}, {fala: "Eu acredito, ainda. Quem fez isso não foi Deus, foram os humanos. Disso tenho certeza. Isso me ajuda a enfrentar tudo de cabeça erguida.", retrato: spr_davi_neutro/*davi neutro*/, personagem: "Davi"}],
	[{fala: "Você fica muito tempo calado, pai. O silêncio desse bunker pesa demais.", retrato: spr_davi_neutro/*davi neutro*/, personagem: "Davi"}],
	[{fala: "Como será que está o céu hoje? Queria poder vez de novo...", retrato: spr_davi_deprimido/*davi triste*/, personagem: "Davi"}],
	[{fala: "Queria poder assistir um filme de novo; só mais uma vez...", retrato: spr_roger_neutro/*roger neutro*/, personagem: "Roger"}],
	[{fala: "Pai, aonde você acha que vão os mortos?", retrato: spr_davi_neutro/*davi neutro*/, personagem: "Davi"}, {fala: "Para lugar nenhum. A morte é o fim, ponto.", retrato: spr_roger_neutro/*roger neutro*/, personagem: "Roger"}, {fala: "Com você é tudo preto no branco, né?", retrato: spr_davi_neutro/*davi neutro*/, personagem: "Davi"}],
	//25
	[{fala: "Pai, quem você acha que lançou as bombas?", retrato: spr_davi_neutro/*davi neutro*/, personagem: "Davi", respostas: {um: "O governo americano", dois: "Os nazistas", tres: "Os japas"}, respostas2: {um: {fala: "Duvido muito... por que fariam isso?", retrato: spr_davi_neutro, personagem: "Davi"}, dois: {fala: "Só pode ter sido eles...", retrato: spr_roger_neutro/*roger neutro*/, personagem: "Davi"}, tres: {fala: "Filhos da puta! Primeiro Pearl Harbor, e agora isso!", retrato: spr_davi_neutro, personagem: "Davi"}}}],
	...
	[{fala: "Filho, saiba que sempre que algo acontecer, pode contar comigo. Sou seu pai e te amo.", retrato: spr_roger_neutro/*roger neutro*/, personagem: "Roger"}],
	[{fala: "A solidão me faz sentir tão depressivo... tenho saudade da escola, mesmo que também passasse o tempo todo sozinho.", retrato: spr_davi_neutro/*davi triste*/, personagem: "Davi"}],
	[{fala: "Obrigado por estar aqui, pai. Não sobreviveria 1 dia sem você!", retrato: spr_davi_extasiado/*davi feliz*/, personagem: "Davi"}],
	//30
	[{fala: "E as menininha, Davi? Tava interessado em alguma?", retrato: spr_roger_extasiado/*roger feliz*/, personagem: "Roger"}, {fala: "Não começa, pai.", retrato: spr_davi_colerico/*davi nervoso*/, personagem: "Davi"}],
	[{fala: "Saudade do mundo... Saudade da vida... Que droga de bunker maldito!", retrato: spr_davi_colerico/*davi nervoso*/, personagem: "Davi"}],
	[{fala: "Bom dia, pai.", retrato: spr_davi_neutro/*davi neutro*/, personagem: "Davi"}, {fala: "Bom dia, filho.", retrato: spr_roger_extasiado/*roger feliz*/, personagem: "Roger"}],
	[{fala: "Davi... fica quieto, acho que tem alguma coisa se espreitando aqui dentro...", retrato: spr_roger_apavorado/*roger apavorado*/, personagem: "Roger"}, {fala: "!!!", retrato: spr_davi_apavorado/*davi apávorado*/, personagem: "Davi"},
	{fala: "AAAAAAHHHH!!!", retrato: spr_roger_apavorado/*roger apavorado*/, personagem: "Roger"}, {fala: "UMA BARATA ENORME! MATA ELA, FILHO!", retrato: spr_roger_apavorado, personagem: "Roger"}, {fala: "Ah, para, pai, só um insetosinho... eles devem ser mais limpos que nós a esse altura. Deixa que eu resolvo. ", retrato: spr_davi_neutro/*davi neutro*/, personagem: "Davi"}],
	[{fala: "Você é feliz, pai?", retrato: spr_davi_neutro/*davi neutro*/, personagem: "Davi", respostas: {um: "Sim, muito", dois: "Nunca fui", tres: "Depende, o que é felicidade?"}, respostas2: {um: {fala: "Sério? Que vida boa, hein.", retrato: spr_davi_neutro, personagem: "Davi"}, dois: {fala: "Poxa, sinto muito.", retrato: spr_roger_neutro/*roger neutro*/, personagem: "Davi"}, tres: {fala: "Bem, para os gregos, a felicidade é o instante de vida que vale por si mesmo: um momento que queremos que dure um pouco mais!", retrato: spr_davi_neutro, personagem: "Davi",}}}],
	//35
	[{fala: "Quer ouvir uma piada, pai?", retrato: spr_davi_neutro/*davi neutro*/, personagem: "Davi"}, {fala: "Acho que fica pra próxima, filho.", retrato: spr_roger_neutro/*roger neutro*/, personagem: "Roger"}],
	[{fala: "Você acredita em Deus, pai?", retrato: spr_davi_neutro/*davi neutro*/, personagem: "Davi"}, {fala: "Acreditava", retrato: spr_roger_neutro/*roger neutro*/, personagem: "Roger"}, {fala: "Eu acredito, ainda. Quem fez isso não foi Deus, foram os humanos. Disso tenho certeza. Isso me ajuda a enfrentar tudo de cabeça erguida.", retrato: spr_davi_neutro/*davi neutro*/, personagem: "Davi"}],
	[{fala: "Música favorita, pai?", retrato: spr_davi_neutro/*davi neutro*/, personagem: "Davi"}, {fala: "'In the Mood', Glenn Miller... Sua mãe e eu dançávamos essa direto na nossa época.", retrato: spr_davi_neutro/*davi neutro*/, personagem: "Davi"}],
	[{fala: "Poxa, pai... É como diz o outro: os tempos bons só são assim reconhecidos depois que passamos por eles...", retrato: spr_davi_deprimido/*davi triste*/, personagem: "Davi"}],
	[{fala: "Bom dia, Davi! Como tem passado? Sei que estamos o tempo todo juntos aqui, mas raramente temos uma conversa mais profunda.", retrato: spr_roger_neutro/*roger neutro*/, personagem: "Roger"}, {fala: "Sendo bem sincero, pai... me sinto mais deprimido agora que durante toda minha vida. Quando a mamãe morreu... pensei que o mundo tinha acabado; mas agora, olha que irônico: ele realmente acabou! HAHAHAHAHAHAHH!!", retrato: spr_davi_neutro/*davi neutro*/, personagem: "Davi"}],
	//40
	[{fala: "Você fica muito tempo calado, pai. O silêncio desse bunker pesa demais.", retrato: spr_davi_neutro/*davi neutro*/, personagem: "Davi"}],
	[{fala: "Como será que está o céu hoje? Queria poder vez de novo...", retrato: spr_davi_deprimido/*davi triste*/, personagem: "Davi"}],
	[{fala: "Queria poder assistir um filme de novo; só mais uma vez...", retrato: spr_roger_neutro/*roger neutro*/, personagem: "Roger"}],
	[{fala: "Pai, aonde você acha que vão os mortos?", retrato: spr_davi_neutro/*davi neutro*/, personagem: "Davi"}, {fala: "Para lugar nenhum. A morte é o fim, ponto.", retrato: spr_roger_neutro/*roger neutro*/, personagem: "Roger"}, {fala: "Com você é tudo preto no branco, né?", retrato: spr_davi_neutro/*davi neutro*/, personagem: "Davi"}],
	[{ fala: "Hoje você acordou cedo.", retrato: spr_roger_neutro, personagem: "Roger"}, {fala: "Já disse isso: é tão silencioso que incomoda!", retrato: spr_davi_neutro, personagem: "Davi"}],
	//45
	[{fala: "Pai, se eu morrer antes de você...", retrato: spr_davi_neutro, personagem: "Davi"}, {fala: "Não fala isso...", retrato: spr_roger_neutro, personagem: "Roger"}, {fala: "... você me queimaria ou enterraria?", retrato: spr_davi_neutro, personagem: "Davi"}, {fala: "Não quero pensar nisso, filho... mas acho mais correto enterrar do lado de fora. Lá no quintal, onde você brincava quando criança.", retrato: spr_roger_neutro, personagem: "Roger"}],
	[{fala: "Pai, olha, você deveria começar a meditar, que nem eu!", retrato: spr_davi_extasiado, personagem: "Davi"}, {fala: "Não preciso dessas coisas...", retrato: spr_roger_neutro, personagem: "Roger"}, {fala: "Mas tenta! Olha que me ajuda bastante!", retrato: spr_davi_extasiado, personagem: "Davi"}],
	[{fala: "Pai, fala um cheiro bom.", retrato: spr_davi_extasiado, personagem: "Davi", respostas: {um: "Grama recém-cortada", dois: "Gasolina", tres: "Lavanda"}, respostas2: {um: {fala: "É bom mesmo.", retrato: spr_davi_neutro, personagem: "Davi"}, dois: {fala: "Credo... negócio ruim!", retrato: spr_davi_neutro/*roger neutro*/, personagem: "Davi"}, tres: {fala: "Bom gosto, pai, bom gosto se chama.", retrato: spr_davi_neutro, personagem: "Davi",}}}],
	[{fala: "Eu queria muito aprender a tocar violão... ", retrato: spr_davi_neutro, personagem: "Davi"}, {fala: "E eu queria visitar a América do Sul... lá tem paisagens muito bonitas... Enfim, a gente não pode ter tudo, né?", retrato: spr_roger_extasiado, personagem: "Roger"}],
	[{fala: "Hoje faz 50 dias... parece uma vida!", retrato: spr_roger_extasiado, personagem: "Roger"}],
	//50
