	...
	if !todas_chaves {
		...
		if !todos_espanador {
			...
			if !espanador1 {
				...
				draw_set_color(#487F7D)
				draw_circle(x11, y11 - 90, 36, false)
			...
			if !espanador2 {
				...
				draw_set_color(#487F7D)
				draw_circle(x22, y22 - 90, 36, false)
			...
			if !espanador3 {
				...
				draw_set_color(#487F7D)
				draw_circle(x33, y33 - 90, 36, false)
